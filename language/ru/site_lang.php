...
$lang['proj_desc3'] = 'Это отнимет всего 3 минуты. Подключите скрипт да таблицу стилей, затем скопируйте пару строк HTML-кода. Готово! <br><br>Подробности на странице <a class="github" href="https://github.com/burocratik/outdated-browser">GitHub</a> ;)';
