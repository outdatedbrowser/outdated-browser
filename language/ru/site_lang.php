...
$lang['proj_desc2'] = 'Будучи запущенным, скрипт проверяет, поддерживает ли браузер CSS-свойство. Если же нет, мы показываем милое и стильное уведомление, рекомендующее пользователю обновиться к новой версии.';
